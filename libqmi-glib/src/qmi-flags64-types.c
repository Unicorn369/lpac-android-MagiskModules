...
static const GFlags64Value qmi_dsd_so_mask_values[] = {
    { QMI_DSD_3GPP_SO_MASK_WCDMA, "QMI_DSD_3GPP_SO_MASK_WCDMA", "3gpp-so-mask-wcdma" },
    { QMI_DSD_3GPP_SO_MASK_HSDPA, "QMI_DSD_3GPP_SO_MASK_HSDPA", "3gpp-so-mask-hsdpa" },
    { QMI_DSD_3GPP_SO_MASK_HSUPA, "QMI_DSD_3GPP_SO_MASK_HSUPA", "3gpp-so-mask-hsupa" },
    { QMI_DSD_3GPP_SO_MASK_HSDPAPLUS, "QMI_DSD_3GPP_SO_MASK_HSDPAPLUS", "3gpp-so-mask-hsdpaplus" },
    { QMI_DSD_3GPP_SO_MASK_DC_HSDPAPLUS, "QMI_DSD_3GPP_SO_MASK_DC_HSDPAPLUS", "3gpp-so-mask-dc-hsdpaplus" },
    { QMI_DSD_3GPP_SO_MASK_64_QAM, "QMI_DSD_3GPP_SO_MASK_64_QAM", "3gpp-so-mask-64-qam" },
    { QMI_DSD_3GPP_SO_MASK_HSPA, "QMI_DSD_3GPP_SO_MASK_HSPA", "3gpp-so-mask-hspa" },
    { QMI_DSD_3GPP_SO_MASK_GPRS, "QMI_DSD_3GPP_SO_MASK_GPRS", "3gpp-so-mask-gprs" },
    { QMI_DSD_3GPP_SO_MASK_EDGE, "QMI_DSD_3GPP_SO_MASK_EDGE", "3gpp-so-mask-edge" },
    { QMI_DSD_3GPP_SO_MASK_GSM, "QMI_DSD_3GPP_SO_MASK_GSM", "3gpp-so-mask-gsm" },
    { QMI_DSD_3GPP_SO_MASK_S2B, "QMI_DSD_3GPP_SO_MASK_S2B", "3gpp-so-mask-s2b" },
    { QMI_DSD_3GPP_SO_MASK_LTE_LIMITED_SRVC, "QMI_DSD_3GPP_SO_MASK_LTE_LIMITED_SRVC", "3gpp-so-mask-lte-limited-srvc" },
    { QMI_DSD_3GPP_SO_MASK_LTE_FDD, "QMI_DSD_3GPP_SO_MASK_LTE_FDD", "3gpp-so-mask-lte-fdd" },
    { QMI_DSD_3GPP_SO_MASK_LTE_TDD, "QMI_DSD_3GPP_SO_MASK_LTE_TDD", "3gpp-so-mask-lte-tdd" },
    { QMI_DSD_3GPP_SO_MASK_TDSCDMA, "QMI_DSD_3GPP_SO_MASK_TDSCDMA", "3gpp-so-mask-tdscdma" },
    { QMI_DSD_3GPP_SO_MASK_DC_HSUPA, "QMI_DSD_3GPP_SO_MASK_DC_HSUPA", "3gpp-so-mask-dc-hsupa" },
    { QMI_DSD_3GPP_SO_MASK_LTE_CA_DL, "QMI_DSD_3GPP_SO_MASK_LTE_CA_DL", "3gpp-so-mask-lte-ca-dl" },
    { QMI_DSD_3GPP_SO_MASK_LTE_CA_UL, "QMI_DSD_3GPP_SO_MASK_LTE_CA_UL", "3gpp-so-mask-lte-ca-ul" },
    { QMI_DSD_3GPP_SO_MASK_S2B_LIMITED_SRVC, "QMI_DSD_3GPP_SO_MASK_S2B_LIMITED_SRVC", "3gpp-so-mask-s2b-limited-srvc" },
    { QMI_DSD_3GPP_SO_MASK_FOUR_POINT_FIVE_G, "QMI_DSD_3GPP_SO_MASK_FOUR_POINT_FIVE_G", "3gpp-so-mask-four-point-five-g" },
    { QMI_DSD_3GPP_SO_MASK_FOUR_POINT_FIVE_G_PLUS, "QMI_DSD_3GPP_SO_MASK_FOUR_POINT_FIVE_G_PLUS", "3gpp-so-mask-four-point-five-g-plus" },
    { QMI_DSD_3GPP2_SO_MASK_1X_IS95, "QMI_DSD_3GPP2_SO_MASK_1X_IS95", "3gpp2-so-mask-1x-is95" },
    { QMI_DSD_3GPP2_SO_MASK_1X_IS2000, "QMI_DSD_3GPP2_SO_MASK_1X_IS2000", "3gpp2-so-mask-1x-is2000" },
    { QMI_DSD_3GPP2_SO_MASK_1X_IS2000_REL_A, "QMI_DSD_3GPP2_SO_MASK_1X_IS2000_REL_A", "3gpp2-so-mask-1x-is2000-rel-a" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REV0_DPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REV0_DPA", "3gpp2-so-mask-hdr-rev0-dpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVA_DPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVA_DPA", "3gpp2-so-mask-hdr-reva-dpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVB_DPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVB_DPA", "3gpp2-so-mask-hdr-revb-dpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVA_MPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVA_MPA", "3gpp2-so-mask-hdr-reva-mpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVB_MPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVB_MPA", "3gpp2-so-mask-hdr-revb-mpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVA_EMPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVA_EMPA", "3gpp2-so-mask-hdr-reva-empa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVB_EMPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVB_EMPA", "3gpp2-so-mask-hdr-revb-empa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_REVB_MMPA, "QMI_DSD_3GPP2_SO_MASK_HDR_REVB_MMPA", "3gpp2-so-mask-hdr-revb-mmpa" },
    { QMI_DSD_3GPP2_SO_MASK_HDR_EVDO_FMC, "QMI_DSD_3GPP2_SO_MASK_HDR_EVDO_FMC", "3gpp2-so-mask-hdr-evdo-fmc" },
    { QMI_DSD_3GPP2_SO_MASK_1X_CS, "QMI_DSD_3GPP2_SO_MASK_1X_CS", "3gpp2-so-mask-1x-cs" },
    { QMI_DSD_3GPP_SO_MASK_5G_TDD, "QMI_DSD_3GPP_SO_MASK_5G_TDD", "3gpp-so-mask-5g-tdd" },
    { QMI_DSD_3GPP_SO_MASK_5G_SUB6, "QMI_DSD_3GPP_SO_MASK_5G_SUB6", "3gpp-so-mask-5g-sub6" },
    { QMI_DSD_3GPP_SO_MASK_5G_MMWAVE, "QMI_DSD_3GPP_SO_MASK_5G_MMWAVE", "3gpp-so-mask-5g-mmwave" },
    { QMI_DSD_3GPP_SO_MASK_5G_NSA, "QMI_DSD_3GPP_SO_MASK_5G_NSA", "3gpp-so-mask-5g-nsa" },
    { QMI_DSD_3GPP_SO_MASK_5G_SA, "QMI_DSD_3GPP_SO_MASK_5G_SA", "3gpp-so-mask-5g-sa" },
    { 0, NULL, NULL }
};

gchar *
qmi_dsd_so_mask_build_string_from_mask (QmiDsdSoMask mask)
{
    guint i;
    gboolean first = TRUE;
    GString *str = NULL;

    for (i = 0; qmi_dsd_so_mask_values[i].value_nick; i++) {
        /* We also look for exact matches */
        if (mask == qmi_dsd_so_mask_values[i].value) {
            if (str)
                g_string_free (str, TRUE);
            return g_strdup (qmi_dsd_so_mask_values[i].value_nick);
        }

        /* Build list with single-bit masks */
        if (mask & qmi_dsd_so_mask_values[i].value) {
            guint c;
            guint64 number = qmi_dsd_so_mask_values[i].value;
            ...
            if (c == 1) {
                ...
                g_string_append_printf (str, "%s%s",
                                        first ? "" : ", ",
                                        qmi_dsd_so_mask_values[i].value_nick);
                if (first)
                    first = FALSE;
            }
        }
...
static const GFlags64Value qmi_wds_apn_type_mask_values[] = {
    ...
    { QMI_WDS_APN_TYPE_MASK_DUN, "QMI_WDS_APN_TYPE_MASK_DUN", "dun" },
    { QMI_WDS_APN_TYPE_MASK_SUPL, "QMI_WDS_APN_TYPE_MASK_SUPL", "supl" },
    { QMI_WDS_APN_TYPE_MASK_HIPRI, "QMI_WDS_APN_TYPE_MASK_HIPRI", "hipri" },
    { QMI_WDS_APN_TYPE_MASK_FOTA, "QMI_WDS_APN_TYPE_MASK_FOTA", "fota" },
    { QMI_WDS_APN_TYPE_MASK_CBS, "QMI_WDS_APN_TYPE_MASK_CBS", "cbs" },
    ...
    { QMI_WDS_APN_TYPE_MASK_UT, "QMI_WDS_APN_TYPE_MASK_UT", "ut" },
    { QMI_WDS_APN_TYPE_MASK_MCX, "QMI_WDS_APN_TYPE_MASK_MCX", "mcx" },
    { 0, NULL, NULL }
};
