...
#define PACKAGE_STRING "pcsc-lite 2.0.0"
...
#if defined(__arm__)
    #define PCSCD_ARCH "android-arm"
#elif defined(__aarch64__)
    #define PCSCD_ARCH "android-arm64"
#elif defined(__i386__)
    #define PCSCD_ARCH "android-x86"
#elif defined(__x86_64__)
    #define PCSCD_ARCH "android-x86_64"
#else
    #define PCSCD_ARCH "android"
#endif
